...
class Ina219Interface : public ISensorInterface {
public:
    Ina219Interface(std::string deviceId, SensorId sensorId, float correctionCoefficient, float shift);
...
private:
    ...
    bool calc_overflow;
    uint16_t writeRegister(uint8_t reg, uint16_t val);
